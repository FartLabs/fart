...
## 🌌 The Closed Loop (Aspirational)

This project is built with the ambition of forming a closed-loop execution
substrate for autonomous coding agents. While we haven't started experimenting
with [GEPA (Genetic-Pareto)](https://github.com/gepa-ai/gepa) itself yet, Fart
is designed as a structural foundation that perfectly complements GEPA's unique
