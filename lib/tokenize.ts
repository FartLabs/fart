...
export class Token {
  ...
  static getKindOf(raw: string): Lexicon | null {
    switch (raw) {
      ...
      case LEXICON[Lexicon.RequiredSetter]: return Lexicon.RequiredSetter;
...
interface LexiconUtil {
  ...
  required_marker: (line: number, column: number) => Token;
...
export const T: LexiconUtil = {
  ...
  denester: (line, column) => new Token(LEXICON[Lexicon.Denester], line, column),
  opening_angle: (line, column) => new Token(LEXICON[Lexicon.OpeningAngle], line, column),
  closing_angle: (line, column) => new Token(LEXICON[Lexicon.ClosingAngle], line, column),
  setter: (line, column) => new Token(LEXICON[Lexicon.Setter], line, column),
  required_marker: (line, column) => new Token(LEXICON[Lexicon.RequiredMarker], line, column),
  type_definer: (line, column) => new Token(LEXICON[Lexicon.TypeDefiner], line, column),
  depo_definer: (line, column) => new Token(LEXICON[Lexicon.DepoDefiner], line, column),
  impo_definer: (line, column) => new Token(LEXICON[Lexicon.ImpoDefiner], line, column),
  commenter: (line, column) => new Token(LEXICON[Lexicon.Commenter], line, column),
  separator: (line, column) => new Token(LEXICON[Lexicon.Separator], line, column),
  spacer: (line, column) => new Token(LEXICON[Lexicon.Spacer], line, column),
  line_breaker: (line, column) => new Token(LEXICON[Lexicon.LineBreaker], line, column),
  line_breaker2: (line, column) => new Token(LEXICON[Lexicon.LineBreaker2], line, column),
