...
[`mod.fart`](https://etok.codes/fart/blob/main/ex/pokemon/mod.fart), and an
implementation file,
[`run.ts`](https://etok.codes/fart/blob/main/ex/pokemon/run.ts).
...
[`pokeball.ts`](https://etok.codes/fart/blob/main/ex/pokemon/pokeball.ts) and
[`dex.ts`](https://etok.codes/fart/blob/main/ex/pokemon/dex.ts) files show how
Fart types can be naturally extended in TypeScript.
