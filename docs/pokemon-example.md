...
This example runs on two files: a type declaration file, [`mod.fart`](https://github.com/EthanThatOneKid/fart/blob/main/ex/pokemon/mod.fart), and an implementation file, [`run.ts`](https://github.com/EthanThatOneKid/fart/blob/main/ex/pokemon/run.ts).
...
The [`pokeball.ts`](https://github.com/EthanThatOneKid/fart/blob/main/ex/pokemon/pokeball.ts) and [`dex.ts`](https://github.com/EthanThatOneKid/fart/blob/main/ex/pokemon/dex.ts) files show how Fart types can be naturally extended in TypeScript.
